...
local Window = WindUI:CreateWindow({
    Title = "Aether",
    Icon = "rbxassetid://87395491039015",
    Author = "good,cozzy",
    Folder = "Aether",
...
(getgenv()).Load = function()
    if readfile and writefile and isfile and isfolder then
        ...
        if not isfolder("Aether/Blox Fruits/") then
            makefolder("Aether/Blox Fruits/");
        end
        if not isfile(("Aether/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
            writefile("Aether/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json",
                (game:GetService("HttpService")):JSONEncode(_G.Settings));
        else
            local Decode = (game:GetService("HttpService")):JSONDecode(readfile(
                "Aether/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
